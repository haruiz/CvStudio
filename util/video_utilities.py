...
import os
#import skvideo
#skvideo.setFFmpegPath(os.path.abspath("./../bin"))
import cv2
#import ffmpeg
...
if __name__ == '__main__':
    pass
    #video_path = r"C:\Users\henry.ruiz\Hiv00130-1700-1715_CUT.mp4"
    #result = VideoUtilities.duration(video_path)
    #print(result, math.floor(result), math.ceil(result))
