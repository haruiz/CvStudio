...
from PyQt5.QtCore import QObject, pyqtSignal, QModelIndex, QRect
from PyQt5.QtGui import QStandardItemModel, QContextMenuEvent, QIcon, QPainter, QColor, QMouseEvent
from PyQt5.QtWidgets import QAction, QMenu, QAbstractItemView, QTableView, QHeaderView, QWidget, \
